module.exports = {
    run: function(creep) {
        if (Game.flags['RemoteMine']){
			var mineroom = Game.flags['RemoteMine2'].pos.roomName;
			var flag = Game.flags['RemoteMine2'].pos;
		}
		        if (Game.flags['Deposit2']){
			var depositroom = Game.flags['Deposit2'].pos.roomName;
			var dflag = Game.flags['Deposit2'].pos;
		}
